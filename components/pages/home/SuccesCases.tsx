...
export default function SuccesCases() {
  ...
  return (
    <div className="pb-[0px] mt-[41px] lg:pb-[120px] w-full flex justify-center relative z-10">
      ...
      <div className="container relative z-10">
        <div className="flex flex-col md:items-center justify-center">
          ...
          {isDesktop ? (
            <p className="max-w-[680px] pt-6 text-grey-parrafo w-full text-center">
              {t("sub")}
            </p>
          ) : (
            <p className=" pt-6 w-[90%] leading-7 text-grey-parrafo text-[18px] px-4 pb-8">
              {t("subM")}
            </p>
          )}
          ...
          <div className="mt-5 relative">
            {blogList[0] && blogList[1] && blogList[2] && !isDesktop ? (
              <Swiper
                slidesPerView={1.1}
                spaceBetween={5}
                grabCursor={true}
