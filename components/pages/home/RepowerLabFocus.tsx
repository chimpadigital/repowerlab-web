      ...
      <div className="container">
        ...
        <div className="pt-12 grid grid-cols-2 ">
          ...
          <div className="lg:col-span-1 col-span-2 flex flex-col items-center justify-center text-primary text-[22px] font-light">
            <p>
              With a strong presence in Europe, the US, and Latin America, we
              have{" "}
              ...
              that include strategic planning, asset recovery, and the resale
              and installation of refurbished equipment.
            </p>
            <p className="pt-2">
              Committed to sustainability, we utilize advanced European
              recycling technologies to achieve{" "}
              <strong className="text-accent font-bold">
                high material recovery rates.
              </strong>{" "}
              By enhancing the performance and efficiency of energy assets,
              RepowerLab promotes environmental stewardship, driving{" "}
              <strong className="text-accent font-bold">
