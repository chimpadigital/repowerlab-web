  ...
  return (
    <div className="w-full px-4 lg:px-8 items-center flex-col flex justify-center relative pb-[41px] md:pb-[150px]">
      <div className="w-full relative flex justify-center overflow-hidden h-full min-h-[90vh] max-h-[1500px]  rounded-[20px] ">
        ...
        <video
          className="object-cover bg-secondary md:object-center object-[-150px] w-full h-full top-0 left-0 absolute z-0"
          autoPlay
          muted
          playsInline
          loop
            ...
            <div className="col-span-2 lg:col-span-1 h-full flex flex-col justify-center">
              <div className="max-w-[600px]">
                <Title
                  h1
                  className={
                    title({ color: "white", size: "md" }) + " md:hidden w-[80%]"
                  }
                  title={tH.raw("titleMob")}
                ></Title>
                <Title
                  className={
                    title({ color: "white", size: "md" }) +
                    " hidden leading-[1.2] md:block"
                  }
                  title={tH.raw("title")}
                ></Title>
              </div>
              {isDesktop ? (
                <div className="flex gap-[25px] pt-8">
                  <Link
                    href="#products"
                    className={`${button({ whiteLine: true })} block`}
                  >
                    {tH("btn1")}{" "}
                  </Link>
                  <Link
                ...
                <div className="flex  flex-col gap-[25px] pt-8">
                  <Link
                    href="#products"
                    className={`text-white text-[1.2rem] items-center font-bold flex gap-2 block`}
                  >
                    {tH("btn1")} <Arrow />
                  </Link>
                  <Link
