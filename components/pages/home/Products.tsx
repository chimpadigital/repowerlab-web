...
export default function Products() {
  ...
  return (
    <div
      className="pt-0 md:py-[100px] w-full flex-col items-center flex justify-center"
      id="products"
    >
      <div className="container relative z-10 w-full px-4 md:px-8">
        <div className="w-full flex justify-center md:items-center flex-col">
          <h2 className={`${title({ color: "primary" })} md:text-center`}>
            {t("title")}
          </h2>
          <p className="text-center max-w-[800px] pt-12 text-grey-parrafo hidden md:block">
            {t("paragraph")}
          </p>
        </div>
      </div>
      <div className="pt-[60px] w-full hidden lg:block">
        ...
        <div className="py-4 mt-4 flex justify-center w-full">
          <Link
            href="/products/wind-turbines"
            className="w-full mt-6 max-w-[180px] relative overflow-hidden gap-4 items-center transition-all duration-[600] py-2 px-6 rounded-full  text-white flex justify-between hover:max-w-[190px]"
          >
            <div className="w-full absolute h-full top-0 left-0 bg-primary"></div>
