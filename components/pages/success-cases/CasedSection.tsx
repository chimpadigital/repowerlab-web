...
const CasedSection = () => {
  return (
    <div className="px-14 flex gap-6 justify-center text-primary">
      {text.map((item, index) => {
        return (
          <div
            key={index}
            className="w-fit relative group px-14 py-12 origin-top hover:pb-20 transition-all bg-gradient-to-r from-[#fff] to-90% to-[#B3C5DF] shadow-[5px_5px_4px_0px_#0000001A] rounded-[20px] after:inset-0 after:absolute after:bg-grey-100 after:rounded-[20px]  after:transition-all hover:after:opacity-0"
            style={{
              background:
          ...
          >
            <div className="z-10 relative">
              ...
              <p className="max-w-[30ch] transition-all group-hover:-translate-y-24 text-primary">
                {item.text}
              </p>
            </div>
