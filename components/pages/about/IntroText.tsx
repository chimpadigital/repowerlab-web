...
const IntroText = () => {
  return (
    <article className="text-start px-14">
      <motion.p
      ...
      >
        ...
        <span className="font-bold">4 GW of renewable energy </span> across the
        ...
        France, Italy, Spain, the UK, Chile, and Nicaragua, with ongoing
        projects in Italy and France focused on recycling.
      </motion.p>
      <motion.p
        initial={{ opacity: 0, x: 100 }}
        whileInView={{ opacity: 1, x: 0 }}
      ...
      >
        ...
        are committed to sustainability and utilize advanced European recycling
        technologies to achieve high material recovery rates. By enhancing the
        performance and efficiency of energy assets, RepowerLab drives
        innovation, promotes environmental stewardship, and supports a
