  ...
  return (
    <footer className="w-full flex items-center justify-center text-primary mt-4 lg:px-6 px-4 min-h-[400px]  lg:mb-8 mb-[120px]">
      <div className="relative flex justify-center flex-col items-center w-full h-full py-[40px] min-h-[400px] px-14">
        ...
        <div className="w-full relative container z-10 justify-end hidden lg:flex">
          <Link
            href="mailto:info@repowerlab.com"
        ...
        <Image
          ...
          alt="footer"
          className="rounded-[25px] object-cover mx-auto hidden lg:block h-full"
        ></Image>
        <Image
          quality={100}
          fill
          ...
          alt="footer"
          className="rounded-[25px] object-cover mx-auto h-full block lg:hidden"
        ></Image>
      </div>
    </footer>
  );
