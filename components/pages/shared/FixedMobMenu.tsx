    ...
    <>
      ...
      <div className='fixed w-full bottom-6 left-0 px-4 z-[999] flex md:hidden justify-center'>
        <div className="w-full flex px-6 gap-4 justify-between rounded-[20px] py-4 text-white" style={bgNavStyle}>
          ...
          <Link href="/marketplace" className='flex flex-col block items-center gap-1 justify-center'>
            <CircularIcon />
            <small className={`font-bold text-[10px] transition ease duration-[600] ${pathname == '/marketplace' ? "block" : "hidden"}`}>Circular</small>
          </Link>
          <Link href="/circular-economy" className='flex flex-col block items-center gap-1 justify-center'>
            <CartIcon />
          ...
          <Link href="/about/contact-us" className='flex flex-col block items-center gap-1 justify-center'>
            <ContactIcon />
            <small className={`font-bold text-[10px] transition ease duration-[600] ${pathname == '/about/contact-us' ? "block" : "hidden"}`}>Contact</small>
          </Link>
          <div className='flex flex-col block items-center gap-1 justify-center' onClick={() => { setOpen(!open) }}>
            <MenuICon />
