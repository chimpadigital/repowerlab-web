...
export default function JoinOurMission() {
  ...
  const itemClasses = {
    ...
    title:
      "font-normal data-[open=true]:font-bold text-[16px] md:text-[22px] ps-2 md:ps-0 text-primary w-[90%] md:w-[80%]",
    heading:
      "shadow-none data-[open]=true:font-bold md:bg-transparent bg-grey-100",
    content: "shadow-none ps-2 md:px-4 py-2",
    trigger:
      "md:px-2 py-4  shadow-none md:mt-6  font-bold flex items-center border-none pr4",
      ...
      <div className="container text-primary px-4 md:px-6">
        <div className="grid lg:grid-cols-2 cols-1">
          <div className="col-span-1 md:pt-[47px]">
            ...
            {isDesktop ? (
              <Paragraph
                className="text-grey-parrafo text-[20px] pt-[40px] max-w-[450px]"
                text={t.raw("p")}
              />
            ) : (
              <Paragraph
                className="text-grey-parrafo text-[18px] pt-[21px] pb-4 max-w-[450px]"
                text={t.raw("pM")}
              />
            )}
          </div>
            ...
            <div className="col-span-1 mt-6 md:mt-0">
              <Accordion variant="splitted" itemClasses={itemClasses}>
                ...
                <AccordionItem
                  ...
                  title={t("accordion.ac2.title")}
                >
                  <hr className="w-full border border-grey-600/15" />
                  <div className="pt-4 px-2 md:px-0">
                    <Paragraph
                      text={t.raw("accordion.ac2.p")}
                      className="text-grey-parrafo"
                    />
                  </div>
                </AccordionItem>
                <AccordionItem
                  ...
                  title={t.raw("accordion.ac3.title")}
                >
                  <hr className="w-full border border-grey-600/15" />
                  <div className="pt-4 px-2 md:px-0">
                    <Paragraph
                      text={t.raw("accordion.ac3.p")}
                      className="text-grey-parrafo"
                    />
                  </div>
                </AccordionItem>
            ...
            <div className="col-span-1 mt-6 md:mt-0">
              ...
              >
                <AccordionItem
                  ...
                  key="1"
                  aria-label="Accordion 1"
                  title={t.raw("accordion.ac1.titleM")}
                >
                  <hr className="w-full border border-grey-600/15" />
                  <div className="pt-4">
                    <Paragraph
                      text={t.raw("accordion.ac1.pM")}
                      className="text-grey-parrafo"
                    />
                  </div>
                </AccordionItem>
                <AccordionItem
                  ...
                  key="2"
                  aria-label="Accordion 2"
                  title={t("accordion.ac2.titleM")}
                >
                  <hr className="w-full border border-grey-600/15" />
                  <div className="pt-4">
                    <Paragraph
                      text={t.raw("accordion.ac2.pM")}
                      className="text-grey-parrafo"
                    />
                  </div>
                </AccordionItem>
                <AccordionItem
                  ...
                  key="3"
                  aria-label="Accordion 3"
                  title={t.raw("accordion.ac3.titleM")}
                >
                  <hr className="w-full border border-grey-600/15" />
                  <div className="pt-4">
                    <Paragraph
                      text={t.raw("accordion.ac3.pM")}
                      className="text-grey-parrafo"
                    />
                  </div>
                </AccordionItem>
...
const Cards = ({
  ...
  return (
    <article
      className="text-primary bg-secondary rounded-[20px] px-8 pt-6 pb-8 w-[25%] w-full max-w-[400px] min-w-[300px]"
      style={{ boxShadow: "4px 4px 4px 0px rgba(0, 0, 0, 0.10)" }}
    >
      <img
        className="w-[40px] h-[40px] mb-4 md:hidden"
        src={`/images/how-we-work/${image}.png`}
        alt=""
      />
      ...
      <ul className="pt-4 md:pt-6">
        {list.map((el, i) => (
          <motion.li
            ...
            key={i}
            transition={{ delay: 0.2 * i, duration: 0.6, ease: "linear" }}
            className="flex gap-2  py-1 px-0 items-start"
          >
            <span>
              <svg
              ...
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M4.74678 9.59881L12.5884 0.101307C12.7 -0.0337692 12.8812 -0.0337692 12.9927 0.101307L14.0429 1.37328C14.1545 1.50836 14.1545 1.72714 14.0429 1.86294L4.94832 12.8983C4.83679 13.0334 4.65615 13.0341 4.54403 12.899L0.0841537 7.51633C-0.0279542 7.38125 -0.0279542 7.16175 0.0835729 7.02667L1.15121 5.73359C1.26274 5.59851 1.44397 5.59851 1.5555 5.73359L4.74678 9.59881Z"
                  fill="#1C4741"
                />
              </svg>
            </span>
