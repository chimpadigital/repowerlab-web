...
export default function AccordionMob({
    ...
    const itemClasses = {
        ...
        trigger: "px-0 py-2  shadow-none mt-6  font-bold flex items-center border-none pr4",
    ...
    return (
        <div className='p-4 py-2 w-full'>
            <article className="bg-grey-100 rounded-[20px] px-4 py-8">
                <h5 className={title({ size: "sm", color: "primary" })}>{items[0].title}</h5>
                <p className="pt-4 text-grey-parrafo">{items[0].description}</p>
