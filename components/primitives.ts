...
export const title = tv({
  ...
  variants: {
    ...
    size: {
      ...
      md: "text-[25px] md:text-[30px] md:text-[2.3rem] lg:text-[36px] leading-9",
...
export const subtitle = tv({
  base: "w-full md:w-1/2 my-2 font-[600] text-white text-[20px] lg:text-[26px] block max-w-full",
  variants: {
    colors: {
      primary: "text-primary",
      secondary: "text-secondary",
...
export const button = tv({
  ...
  variants: {
    ...
    whiteLine: {
      true: "hover:border-transparent bg-transparent text-white hover:text-primary border-white before:bg-secondary",
    },
  },
  defaultVariants: {
    greenLine: true,
