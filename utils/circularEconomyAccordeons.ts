...
export const circularEconomySolutions = [
    {
        ...
        description:
            "Our circular economy solutions aim to minimize waste and maximize resource utilization throughout the wind turbine lifecycle.", img: "/images/circular-economy/circular-economy-solution.webp",
    },
    {
...
export const refurbishmentSolutions = [
    {
        ...
        description:
            "Refurbishing wind turbines involves overhauling and upgrading components to restore them to optimal condition. This extends the lifespan of turbines and improves their performance. ", img: "/images/circular-economy/refurbishment.webp",
    },
    {
