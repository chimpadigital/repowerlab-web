export const decommissioning = [
    ...
    },
    {
        ...
        description:
            "RepowerLab provides innovative dismantling, industrial relocation, and reassembly services, ensuring safe and efficient dismantling. Our experienced team handles all aspects of the process, from the initial assessment to the careful removal of turbine components. Utilizing state-of-the-art equipment and adhering to stringent safety standards, we minimize environmental impact and prepare turbines for either reuse or recycling.",
        descriptionMobile:
            "We provide innovative dismantling, relocation, and reassembly, ensuring safe and efficient processes while minimizing environmental impact for reuse or recycling.",
        img: "/images/our-services/decommissioning.webp",
    },
    {
...
export const repowering = [
    {
        title: "Wind farm repowering",
        description:
            "Boost your wind farm's life and performance with advanced repowering. We maximize efficiency and value while cutting costs.",
        descriptionMobile:
            "Maximize efficiency and value with advanced repowering, extending wind farm life while reducing costs.",
...
export const retrofitting = [
    {
        ...
        description:
            "RepowerLab specializes in repowering wind farms through advanced retrofitting solutions that extend the life and enhance the performance of existing turbines. Our focus is on maximizing the economic value of your energy assets by improving efficiency, increasing energy output, and reducing operational costs, all while adhering to sustainable practices.",
        descriptionMobile:
            "We specialize in extending turbine life and boosting performance through retrofitting, maximizing efficiency, output, and value.",
...
export const bladeRecycling = [
    {
        title: "Blade recycling",
        description:
            "Recycling blades into new products. Leading the way in the circular economy.",
        descriptionMobile:
            "Recycle blades into new products, promoting the circular economy.",
...
export const inspection = [
    {
        title: "Inspection and value recovery",
        description:
            "Providing independent, transparent inspections of wind turbines at various lifecycle stages, Repowerlab helps reduce risks, ensure compliance, and identify opportunities for maintenance or decommissioning.",
        descriptionMobile:
            "RepowerLab provides independent inspections to reduce risks, ensure compliance, and identify opportunities for maintenance or decommissioning.",
