  ...
  return (
    <ReCaptchaProvider reCaptchaKey={process.env.NEXT_PUBLIC_CLAVE_WEB_CAPTCHA}>
        ...
        >
          ...
          <button className="fixed bottom-[120px] md:bottom-4 right-4 bg-accent z-20 rounded-full shadow-xl text-white w-12 h-12 flex items-center justify-center" id="backToTop">
            <span>
